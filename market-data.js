...
const INSTRUMENTS = {
  crypto: [
    { sym: 'BTC',   name: 'Bitcoin',     price: 96420.30, vol: 0.0015 },
    { sym: 'ETH',   name: 'Ethereum',    price: 3420.75,  vol: 0.0018 },
    { sym: 'SOL',   name: 'Solana',      price: 198.42,   vol: 0.0030 },
    { sym: 'DOGE',  name: 'Dogecoin',    price: 0.3845,   vol: 0.0045 },
    { sym: 'XRP',   name: 'Ripple',      price: 2.41,     vol: 0.0028 },
    { sym: 'ADA',   name: 'Cardano',     price: 1.04,     vol: 0.0032 },
    { sym: 'BNB',   name: 'BNB',         price: 712.30,   vol: 0.0020 },
    { sym: 'LINK',  name: 'Chainlink',   price: 22.85,    vol: 0.0028 },
  ],
  stocks: [
    { sym: 'TSLA',  name: 'Tesla Inc.',           price: 342.18, vol: 0.0010 },
    { sym: 'SPACEX',name: 'SpaceX (Private)',     price: 168.42, vol: 0.0012 },
    { sym: 'RKLB',  name: 'Rocket Lab',           price: 28.42,  vol: 0.0020 },
    { sym: 'ASTS',  name: 'AST SpaceMobile',      price: 31.10,  vol: 0.0035 },
    { sym: 'LMT',   name: 'Lockheed Martin',      price: 482.75, vol: 0.0008 },
    { sym: 'BA',    name: 'Boeing',               price: 178.92, vol: 0.0012 },
    { sym: 'NVDA',  name: 'NVIDIA',               price: 142.50, vol: 0.0014 },
    { sym: 'MAXR',  name: 'Maxar Technologies',   price: 53.20,  vol: 0.0018 },
    { sym: 'IRDM',  name: 'Iridium Communications',price: 31.80, vol: 0.0015 },
  ],
  forex: [
